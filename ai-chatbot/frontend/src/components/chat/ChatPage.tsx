...
import type { SessionResponse, ChatMessage as ChatMessageType } from '@/types/chat';
          ...
          {isLoading ? (
            ...
            <div className="flex h-full flex-col items-center justify-center gap-4 p-8">
              ...
              <p className="max-w-md text-center text-slate-600">
                I'm here to help you with operational support questions, system status inquiries,
                troubleshooting, and more. Start a conversation by typing a message below.
              </p>
